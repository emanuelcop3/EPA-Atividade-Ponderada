...
### 1. Carregamento e Preparação dos Dados 2023 
```{r}
...
outliers_preco <- identifica_outliers(cod_data_sample$preco)
print("Outliers identificados na variável 'preco':")
print(outliers_preco)

# Boxplot para 'preco'
boxplot(cod_data_sample$preco, 
...
outliers_quantidade <- identifica_outliers(cod_data_sample$quantidade)
print("Outliers identificados na variável 'quantidade':")
print(outliers_quantidade)

# Boxplot para 'quantidade'
boxplot(cod_data_sample$quantidade, 
        main = " Quantidade ", 
        ylab = "Quantidade", 
        col = "lightblue", 
        border = "darkblue", 
...
Para futuras análises, seria interessante:
- **Incluir variáveis adicionais** como dados demográficos, datas de promoções e categorias de produtos para uma análise mais rica.
- **Aplicar técnicas de segmentação de mercado** para entender melhor os diferentes comportamentos dos consumidores em relação aos preços.
- **Realizar análises temporais** para identificar sazonalidades ou padrões ao longo do tempo.
...
# Criar o boxplot
ggplot(wine_data, aes(x = regiao, y = data_inauguracao, color = regiao)) +
  geom_boxplot() +
  theme_minimal() +
